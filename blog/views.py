...
def phones_view(request):
    ...
    return render(request, "phones_view.html" , { 'form' : UserCreationForm , 'phones': phones , 'username' : auth.get_user(request).username})
...
def phone_view(request, path):
    ...
    if request.method == 'GET':
        ...
        return render(request, "phone.html" , {'form' : UserCreationForm , 'phone': Phone.objects.get(id = int(path)) ,'username' : request.user.username, 'comments':Phone.objects.get(id = int(path)).comments.all()})
        ...
        return render(request, "phone.html" , {'form' : UserCreationForm , 'phone' : Phone.objects.get(id = int(path))})
